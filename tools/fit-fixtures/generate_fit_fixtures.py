...
def fixture_specifications() -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "description": "Strukturell gültige Aktivität ohne Distanz, GPS, Leistung und Trittfrequenz.",
            "serial_number": 1004,
            "start": incomplete_start,
            "end": at(incomplete_start, 900),
            "distance_meters": None,
            "streams": ["timestamp", "heart_rate"],
            "records": [
                {"timestamp": incomplete_start, "heart_rate": 105},
                {"timestamp": at(incomplete_start, 450), "heart_rate": 126},
                {"timestamp": at(incomplete_start, 900), "heart_rate": 119},
            ],
            "laps": [
                {
                    "start": incomplete_start,
